...
void Reyes::RendererOldCL::prepare()
{
...
void Reyes::RendererOldCL::finish()
{
...
bool Reyes::RendererOldCL::are_patches_loaded(void* patches_handle)
{
    return _patch_index->are_patches_loaded(patches_handle);
}


void Reyes::RendererOldCL::load_patches(void* patches_handle, const vector<BezierPatch>& patch_data)
{
    _patch_index->load_patches(patches_handle, patch_data);
}


void Reyes::RendererOldCL::draw_patches(void* patches_handle,
                                         const mat4& matrix,
...
CL::Event Reyes::RendererOldCL::send_batch(Reyes::Batch& batch,
