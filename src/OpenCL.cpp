...
// void CL::CommandQueue::enq_GL_acquire(ImageBuffer& buffer,
//                      const string& name, const CL::Event& events)
// {
...
// void CL::CommandQueue::enq_GL_release(ImageBuffer& buffer,
//                      const string& name, const CL::Event& events)
// {
//     cl_mem mem = buffer.get();
...
// void CL::CommandQueue::enq_GL_acquire(Buffer& mem,
//                      const string& name, const CL::Event& events)
// {
//     cl_mem m = mem.get();
...
// void CL::CommandQueue::enq_GL_release(Buffer& mem,
//                      const string& name, const CL::Event& events)
// {
//     cl_mem m = mem.get();
...
CL::Kernel::Kernel(Device& device, 
